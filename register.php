...
if (isset($_POST['register'])) {
    ...
    $captcha_confirmation = $_POST['captcha_confirmation'];
    ...
    if ($conn->connect_error) {
        $message = "<div class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative'>Database connection failed: " . $conn->connect_error . "</div>";
        $has_error = true;
    }

    // 2. Password Mismatch Check
    if (!$has_error && $password !== $confirmpassword) {
        $message = "<div class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative'>Passwords do not match. Please try again.</div>";
        $has_error = true;
    }
    ...
    if(!$has_error && $captcha !== $captcha_confirmation){
        $message = "<div class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative'>Captcha Verification Failed.</div>";
        $has_error = true;
    }
    ...
    if (!$has_error) {
        ...
        if ($stmt_check_email === false) {
            $message = "<div class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative'>Database error (email check): " . $conn->error . "</div>";
            $has_error = true;
        } else {
            ...
            if ($result_check_email->num_rows > 0) {
                $message = '<div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative">The email has already been taken.</div>';
                $has_error = true;
            }
    ...
    if (!$has_error) {
        ...
        $stmt_insert_user = $conn->prepare("INSERT INTO users (fullname, username, email, phone, country, password, ref_by) VALUES (?, ?, ?, ?, ?, ?, ?)");
        
        // Check if prepare was successful
        if ($stmt_insert_user === false) {
            $message = "<div class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative'>Database error (user insertion): " . $conn->error . "</div>";
        } else {
            // Include ref_by in binding
            $stmt_insert_user->bind_param("sssssss", $fullname, $username, $email, $phone, $country, $hashedPassword, $ref_by);
            ...
            if ($stmt_insert_user->execute()) {
                ...
                try {
                    ...
                    $mail->Subject = 'Successful Registration - jarvistradepro';
                    $mail->Body    = "
                    <html>
                    <head></head>
                    <body style='background-color: #1e2024; padding: 45px;'>
                        <div>
                            ...
                            <h3 style='color: black;'>Mail From support@jarvistradepro.com - Successful Registration</h3>
                        </div>
                        <div style='color: #fff;'>
                            <h3>Dear $fullname,</h3>
                            <p>Welcome to jarvistradepro, an automated trading platform where even investors with zero experience can make profits.</p>
                            <h5>Click the button below to log in and proceed to get the best experience from jarvistradepro</h5>
                            <a style='background-color:#060c39;color:#fff; padding:15px; text-decoration:none;border-radius: 10px;font-size: 20px;'
                            href='https://jarvistradepro.com/login.php'>Sign in</a>
                    ...
                    $mail->send();
                    $message = "<div class='bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative'>Account Created Successfully! Please check your email for more details.</div>";
                    header("refresh: 2;url=login.php"); // Redirect after successful registration and email attempt
                   
                } catch (Exception $e) {
                    $message = "<div class='bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded relative'>Account created, but email could not be sent. Mailer Error: {$mail->ErrorInfo}</div>";
                ...
                $message = "<div class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative'>Error: " . $stmt_insert_user->error . "</div>";
            }
...
<!-- Mirrored from jarvistradepro.com/register by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Nov 2025 13:25:00 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="csrf-token" content="i9IrwrCK1R06ggCyZDQF50Rx1Qj7KD8SHRjYxISu">
    <title>Jarvis Trade Pro - Create Account</title>

    <!-- Favicon -->
    <link href="storage/app/public/photos/pJn9PS13POLAdzHoPqQK0XS0OXycTBtcumJyeBBE.png" rel="icon" type="image/x-icon" />
    ...
    <!-- Lucide Icons -->
    <script src="unpkg.com/lucide%400.553.0/dist/umd/lucide.js"></script>


<!-- Latest compiled and minified CSS -->
<link rel="stylesheet" href="temp/custom/css/bootstrap.min.html">
<!-- jQuery library -->
<script src="temp/custom/js/jquery.min.html"></script>
<!-- Popper JS -->
<script src="temp/custom/js/popper.min.html"></script>
<!-- Latest compiled JavaScript -->
<script src="temp/custom/js/bootstrap.min.html"></script>

<link href="temp/custom/css/main.html" rel="stylesheet"/>
<!-- <link href="404.html" rel="stylesheet" /> -->

<title>Jarvis Trade Pro</title>
<link rel="manifest" href="temp/custom/js/manifest.html">
...
<meta name="keywords" content="Jarvis Trade Pro" />
<meta property="og:image" content="temp/custom/images/icon/icon-310x310.png" />

<meta name="msapplication-square310x310logo" content="https://jarvistradepro.com/storage/app/public/photos/pJn9PS13POLAdzHoPqQK0XS0OXycTBtcumJyeBBE.png">
<meta name="msapplication-square70x70logo" content="https://jarvistradepro.com/storage/app/public/photos/pJn9PS13POLAdzHoPqQK0XS0OXycTBtcumJyeBBE.png">
<meta name="msapplication-square150x150logo" content="https://jarvistradepro.com/storage/app/public/photos/pJn9PS13POLAdzHoPqQK0XS0OXycTBtcumJyeBBE.png">
<meta name="msapplication-wide310x150logo" content="https://jarvistradepro.com/storage/app/public/photos/pJn9PS13POLAdzHoPqQK0XS0OXycTBtcumJyeBBE.png">

<link rel="apple-touch-icon-precomposed" href="storage/app/public/photos/pJn9PS13POLAdzHoPqQK0XS0OXycTBtcumJyeBBE.png">
...
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="storage/app/public/photos/pJn9PS13POLAdzHoPqQK0XS0OXycTBtcumJyeBBE.png" />
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="storage/app/public/photos/pJn9PS13POLAdzHoPqQK0XS0OXycTBtcumJyeBBE.png" />


<meta property="og:site_name" content="Jarvis Trade Pro">
<meta property="og:title" content="Trading With Jarvis Trade Pro" />
<meta name="description" content="Jarvis Trade Pro LIMITED???
INVEST IN A LEADING
...
EXPERTISE.???">
<meta property="og:description" content="Jarvis Trade Pro LIMITED???
INVEST IN A LEADING
TRADE AND INVESTMENT
COMPANY, OPERATING IN
THE UK.
    ...
    <div class="relative z-10 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-2xl">
            ...
            <div class="bg-gray-900 border border-gray-700 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl"
                ...
                <div class="text-center mb-8">
                    ...
                    <div class="flex items-center justify-center mb-6">
                        <img src="logo.png"
                             ...
                             alt="Jarvis Trade Pro" />
                    </div>

                    <!-- Title -->
                    <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-2">
                        Join <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Jarvis Trade Pro</span>
                    </h1>
                ...
                <!-- Registration Form -->
                <form action="" method="POST" class="space-y-6" id="register" x-cloak>
                    <?php  echo $message; ?>
                    <input type="hidden" name="_token" value="i9IrwrCK1R06ggCyZDQF50Rx1Qj7KD8SHRjYxISu">
                ...
                <div x-show="currentStep === 2"
                    ...
                    <input type="hidden" name="captcha_confirmation" value="<?php echo $code; ?>">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                <label for="agree" class="text-sm font-bold text-gray-200 leading-relaxed">
                                    I agree to Jarvis Trade Pro's
                                    <a href="rules.php" target="_blank" class="text-blue-400 hover:text-blue-300 font-bold underline underline-offset-2">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center mt-10 pt-8 border-t border-gray-700 gap-4" x-cloak>
                    ...
                    <button type="submit" name="register" x-show="currentStep === steps.length - 1"
                ...
                <div class="mt-8 text-center space-y-4">
                    ...
                    <p class="text-xs text-gray-500">
                        © 2025 Jarvis Trade Pro. All rights reserved. |
...
<!-- Mirrored from jarvistradepro.com/register by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Nov 2025 13:25:03 GMT -->
</html>
        </div>
    </div>
