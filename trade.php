...
<script type="application/ld+json">
{
    ...
    "itemListElement": [
        ...
        },
        {
            ...
            "position": 2,
            "item": {
                "@id": "https://jarvistradepro.complatforms/ctrader-overview",
                "name": "cTrader"
            }
        },
        {
            ...
            "position": 3,
            "item": {
                "@id": "https://jarvistradepro.comctrader/trade",
                "name": "Trade"
            }
        }
    ]
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="group relative">
                ...
                <div class="relative p-6 bg-gray-800 rounded-xl border border-gray-700 hover:border-blue-500/50 transition-all duration-300">
                    ...
                    <p class="text-gray-300">Featuring the market's sharpest execution, Jarvis Trade Pro Trade cTrader fills your orders in milliseconds without any requotes or price manipulation.</p>
                </div>
            </div>
            ...
            <div class="group relative">
                ...
                <div class="relative p-6 bg-gray-800 rounded-xl border border-gray-700 hover:border-blue-500/50 transition-all duration-300">
                    ...
                    <p class="text-gray-300">Easy to use and navigate, Jarvis Trade Pro Trade cTrader was built with real traders' needs in mind. Trade with Jarvis Trade Pro Trade cTrader and experience its distinct advantage.</p>
                </div>
            </div>
        </div>
    </div>
