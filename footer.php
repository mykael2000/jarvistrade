                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-400 mb-6">
                            Jarvis Trade Pro offers CFD trading on stocks, forex, indices, commodities, and cryptocurrencies with competitive spreads and advanced trading tools.
                        </p>
                        <div class="flex space-x-4">
                            ...
                            <a href="mailto:admin@jarvistradepro.com" class="text-gray-400 hover:text-white">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li><a href="about.php" class="text-sm text-gray-400 hover:text-white transition">About Us</a></li>
                            <li><a href="why-us.php" class="text-sm text-gray-400 hover:text-white transition">Why Choose Us</a></li>
                            <li><a href="for-traders.php" class="text-sm text-gray-400 hover:text-white transition">Education</a></li>
                            <li><a href="contacts.php" class="text-sm text-gray-400 hover:text-white transition">Contact</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li><a href="cryptocurrencies.php" class="text-sm text-gray-400 hover:text-white transition">Cryptocurrencies</a></li>
                            <li><a href="forex.php" class="text-sm text-gray-400 hover:text-white transition">Forex</a></li>
                            <li><a href="shares.php" class="text-sm text-gray-400 hover:text-white transition">Shares</a></li>
                            <li><a href="indices.php" class="text-sm text-gray-400 hover:text-white transition">Indices</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li><a href="login.php" class="text-sm text-gray-400 hover:text-white transition">Log In</a></li>
                            <li><a href="register.php" class="text-sm text-gray-400 hover:text-white transition">Create Account</a></li>
                            <li><a href="login.php" class="text-sm text-gray-400 hover:text-white transition">Demo Account</a></li>
                            <li><a href="contact.php" class="text-sm text-gray-400 hover:text-white transition">Help Center</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="py-6">
                <div class="text-xs text-gray-400">
                    ...
                    <div class="flex flex-wrap gap-4 mb-4">
                        <a href="terms.php" class="text-blue-400 hover:text-blue-300 transition">Terms & Conditions</a>
                        <a href="privacy.php" class="text-blue-400 hover:text-blue-300 transition">Privacy Policy</a>
                        <a href="regulation.php" class="text-blue-400 hover:text-blue-300 transition">Legal Documents</a>
                    </div>
                    <p>© <script>document.write(new Date().getFullYear())</script> Jarvis Trade Pro. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
...
<!--    (function () {-->
<!--        var options = {-->
            <!--whatsapp: "1314985774", // WhatsApp number-->
...
<!-- Mirrored from jarvistradepro.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Nov 2025 13:24:40 GMT -->
</html>
