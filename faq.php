                    ...
                    <div class="divide-y divide-gray-700" x-data="{active: null}">
                        ...
                        <div class="py-4">
                            <button @click="active !== 0 ? active = 0 : active = null" class="flex justify-between items-center w-full focus:outline-none">
                                <h4 class="text-lg font-medium text-white">What is Jarvis Trade Pro?</h4>
                            ...
                            <div x-show="active === 0" x-collapse x-cloak class="mt-3 text-gray-300">
                                <p>Jarvis Trade Pro - Professional team of cryptocurrency industry developers. The main advantage of the company is a unique trading bot that makes a profit at the stage of growth and market decline.</p>
                            </div>
                        </div>

                        <div class="py-4">
                            <button @click="active !== 1 ? active = 1 : active = null" class="flex justify-between items-center w-full focus:outline-none">
                                <h4 class="text-lg font-medium text-white">Is Jarvis Trade Pro an officially registered company?</h4>
                    ...
                    <div class="divide-y divide-gray-700" x-data="{active: null}">
                        ...
                        <div class="py-4">
                            ...
                            <div x-show="active === 3" x-collapse x-cloak class="mt-3 text-gray-300">
                                <p>Any person who has reached the age of majority in their country of residence can register in Jarvis Trade Pro</p>
                            </div>
                        </div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p>Click the Register button. Enter your details to quickly create a FREE Jarvis Trade Pro account.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <div class="flex-shrink-0 h-8 w-8 rounded-full bg-blue-600 flex items-center justify-center mr-3">
                ...
                <div class="p-6 md:p-8">
                    <div class="divide-y divide-gray-700" x-data="{active: null}">
                        ...
                        <div class="py-4">
                            ...
                            <div x-show="active === 1" x-collapse x-cloak class="mt-3">
                                <p class="text-gray-300">Jarvis Trade Pro offers a unique investment and referral program that rewards you not only for partners who came from you to the platform, but also for partners from levels 2,3 and 4. This unique affiliate program brings you passive referral income.</p>
                ...
                <div class="p-6 md:p-8">
                    <div class="divide-y divide-gray-700" x-data="{active: null}">
                        ...
                        <div class="py-4">
                            ...
                            <div x-show="active === 0" x-collapse x-cloak class="mt-3 text-gray-300">
                                <p>Click on the reset password link on the main page of the site in the login section. Enter your username and email address and follow the instructions. You will receive information on how to reset your Jarvis Trade Pro account password.</p>
                            </div>
                        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-8">
            <div class="bg-gray-800 bg-opacity-70 backdrop-blur-sm rounded-2xl border border-gray-700 shadow-xl overflow-hidden p-8">
                ...
                <div class="flex space-x-4 pt-2">
                    <a href="contact.php" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150">
                        Contact Support
