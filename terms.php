...
<section class="py-12 bg-gray-900">
    <div class="container max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="prose prose-lg prose-invert max-w-none">
                    <div class="space-y-8">
                        ...
                        <div>
                            ...
                            <p class="text-gray-300 mb-4">
                                This Privacy Policy is designed to address regulatory requirements of the jurisdictions in which Jarvis Trade Pro offers its Services, including the General Data Protection Regulation ("GDPR"), as enacted by the European Commission. In this Privacy Policy, the term "Service" and "Services" has the same meaning as described in the User Agreement.
                            </p>
                            <p class="text-gray-300 mb-4">
                            ...
                            <p class="text-gray-300 mb-4">
                                Our Services are offered through one or more subsidiaries of Jarvis Trade Pro. By using the Services, you understand that your Personal Data may be used by Jarvis Trade Pro.
                            </p>
                        </div>
                ...
                <div class="mt-12 text-center" x-data="{ open: false }">
                    ...
                    <div x-show="open"
                        ...
                        <p class="text-gray-300">
                            At Jarvis Trade Pro, we are committed to protecting your personal data and privacy rights. For any questions about our privacy practices or to exercise your data protection rights, please contact our Data Protection Officer at privacy{{$settings->site_name}}.com.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <a href="about.php" class="bg-gray-800 bg-opacity-50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 hover:border-blue-500 transition-colors duration-300 group">
            ...
            <a href="contact.php" class="bg-gray-800 bg-opacity-50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 hover:border-blue-500 transition-colors duration-300 group">
            ...
            <a href="register.php" class="bg-gray-800 bg-opacity-50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 hover:border-blue-500 transition-colors duration-300 group">
