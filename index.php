            ...
            <div class="w-full md:w-1/2 order-1 md:order-1" x-data="{ isVisible: false }" x-init="setTimeout(() => { isVisible = true }, 200)">
                ...
                >
                    ...
                    <div class="flex flex-wrap gap-4 mt-8">
                        <a href="register.php" class="px-8 py-3 text-lg font-medium text-white transition-all duration-200 bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-gray-900">
                            Create Account
                        </a>
                        <a href="login.php" class="px-8 py-3 text-lg font-medium text-gray-200 transition-all duration-200 bg-dark-200 border border-gray-700 rounded-lg hover:bg-dark-100 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-900">
                          Login
                        </a>
                    </div>
                </div>
            ...
            <div class="w-full md:w-1/2 order-2 md:order-2">
                <div class="relative overflow-hidden   backdrop-blur-sm bg-opacity-60 bg-gray-800 rounded-2xl border border-gray-700 shadow-[0_0_25px_rgba(59,130,246,0.15)]">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-lg font-bold" :class="price > prevPrice ? 'text-green-400' : price < prevPrice ? 'text-red-400' : 'text-white'"
                                        ...
                                        x-transition:class="price > prevPrice ? 'animate-pulse bg-green-500 bg-opacity-10' : 'animate-pulse bg-red-500 bg-opacity-10'">
                                         $<?php echo get_btc_current_price_usd(); ?>
                                    </span>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 divide-x divide-gray-700 border-t border-gray-700" x-data="{
                         marketData: {
                            volume: '$61,792,439,523',
                            marketCap: '$2,092,054,359,209',
                            ath: '$126,080.00',
                            supply: '19,947,750'
                        },
                        updateMarketData() {
            ...
            <div class="space-y-6">
                <div class="bg-gray-800 bg-opacity-80 p-6 rounded-xl border border-gray-700 hover:border-emerald-500 shadow-lg transition duration-300">
                    ...
                    <div class="mt-8 text-center">
                        <a href="login.php" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 shadow-lg transition duration-300 transform hover:-translate-y-1">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="relative group">
                ...
                <div class="relative bg-dark-400 p-6 rounded-lg border border-gray-700 group-hover:border-blue-500 transition-all duration-300">
                    ...
                    <a href="forex.php" class="text-blue-400 hover:text-blue-300 flex items-center text-sm font-medium">
                        Explore Forex
            ...
            <div class="relative group">
                ...
                <div class="relative bg-dark-400 p-6 rounded-lg border border-gray-700 group-hover:border-green-500 transition-all duration-300">
                    ...
                    <a href="shares.php" class="text-green-400 hover:text-green-300 flex items-center text-sm font-medium">
                        Explore Shares
                        <i class="fas fa-arrow-right ml-1 text-xs"></i>
                    </a>
                </div>
            ...
            <div class="relative group">
                ...
                <div class="relative bg-dark-400 p-6 rounded-lg border border-gray-700 group-hover:border-yellow-500 transition-all duration-300">
                    ...
                    <a href="commodities.php" class="text-yellow-400 hover:text-yellow-300 flex items-center text-sm font-medium">
                        Explore Energies
                        <i class="fas fa-arrow-right ml-1 text-xs"></i>
                    </a>
                </div>
            ...
            <div class="relative group">
                ...
                <div class="relative bg-dark-400 p-6 rounded-lg border border-gray-700 group-hover:border-blue-500 transition-all duration-300">
                    ...
                    <a href="indices.php" class="text-blue-400 hover:text-blue-300 flex items-center text-sm font-medium">
                        Explore Indices
                        <i class="fas fa-arrow-right ml-1 text-xs"></i>
                    </a>
                </div>
...
<section class="py-16 bg-gradient-to-b from-dark-400 to-dark-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-dark-400 rounded-xl overflow-hidden group hover:shadow-xl transition duration-300 transform hover:-translate-y-1 border border-gray-800">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-4 flex justify-between items-center">
                        <a href="cryptocurrencies.php" class="text-primary hover:underline text-sm font-medium flex items-center">
                            Trade now
        ...
        <div class="mt-10 text-center">
            <a href="cryptocurrencies.php" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition duration-150">
        ...
        <iframe
            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-wrap gap-4 mt-4">
                    <a href="for-traders.php" class="inline-flex items-center px-5 py-2 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition duration-150">
                        Explore learning resources
                        <i class="fas fa-graduation-cap ml-2"></i>
                    </a>
                    <a href="login.php" class="inline-flex items-center px-5 py-2 border border-gray-700 text-base font-medium rounded-md text-gray-300 hover:text-white hover:border-gray-500 transition duration-150">
                        Join free webinars
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div class="space-y-8">
                <div class="bg-dark-300 rounded-xl p-6 border border-gray-800 shadow-lg">
                    ...
                    <div class="mt-8">
                        <a href="login.php" class="inline-flex items-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-primary hover:bg-blue-700 transition duration-150">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-4xl mx-auto bg-dark-400 bg-opacity-80 p-8 rounded-xl border border-gray-800 shadow-xl">
            <p class="text-gray-300 leading-relaxed">
                Jarvis Trade Pro has become one of the most reputable brokers in the industry, offering traders CFDs across Forex, Equities, Commodities and Futures. Trading on the Forex market is a legitimate and straightforward way of generating income.
            </p>

            <p class="text-gray-300 leading-relaxed mt-4">
                The good news is that you don't have to be a professional trader in order to make money. All you need is the right personality and the right skill set and you can make money trading on foreign exchanges. Jarvis Trade Pro lets you trade in the way that best suits you.
            </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div class="bg-dark-300 bg-opacity-60 p-4 rounded-lg">
                    ...
                    <p class="text-gray-400 mt-2">
                        With the right tools, information and access to all the world's currencies, Jarvis Trade Pro puts you in control of the trades you make.
                    </p>
                </div>
            </div>

            <div class="mt-8 text-center">
                <a href="about.php" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-primary hover:bg-blue-700 transition duration-150">
                    Learn more about us
                    <i class="fas fa-arrow-right ml-2"></i>
                </a>
            </div>
...
<div class="relative group">
    ...
    <div class="relative bg-gray-800 bg-opacity-90 rounded-xl overflow-hidden border border-gray-700 group-hover:border-blue-600 transform transition-all duration-500 hover:shadow-lg hover:shadow-blue-900/20 hover:-translate-y-1">
        ...
        <div class="h-24 bg-blue-600 flex items-center justify-center relative">
            ...
            <h3 class="text-xl font-bold text-white uppercase tracking-wider">Premier investment</h3>
        </div>

        <!-- Pricing -->
        <div class="p-6 text-center">
            <div class="mb-6">
                <span class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-400">150%</span>
            ...
            <ul class="space-y-3 mb-8">
                ...
                <li class="text-white font-semibold flex items-center justify-center border-t border-gray-700 pt-3 mt-3">
                    ...
                    Min: <span class="text-blue-300 ml-1">$499</span>
                </li>
                <li class="text-white font-semibold flex items-center justify-center">
                    <svg class="w-5 h-5 text-blue-400 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path>
                    </svg>
                    Max: <span class="text-blue-300 ml-1">$999</span>
                </li>
            </ul>

            <!-- CTA Button -->
            <a href="login.php" class="block w-full px-4 py-3 font-medium text-center text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-md transition duration-300 transform hover:-translate-y-1">
                Select Plan
            </a>
        </div>
...
<div class="relative group">
    ...
    <div class="relative bg-gray-800 bg-opacity-90 rounded-xl overflow-hidden border border-gray-700 group-hover:border-blue-600 transform transition-all duration-500 hover:shadow-lg hover:shadow-blue-900/20 hover:-translate-y-1">
        ...
        <div class="p-6 text-center">
            <div class="mb-6">
                <span class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-400">27%</span>
                <span class="text-gray-300 ml-1">/ Trade</span>
            </div>
            ...
            <ul class="space-y-3 mb-8">
                ...
                <li class="text-white font-semibold flex items-center justify-center border-t border-gray-700 pt-3 mt-3">
                    ...
                    Min: <span class="text-blue-300 ml-1">$199</span>
                </li>
                <li class="text-white font-semibold flex items-center justify-center">
                    <svg class="w-5 h-5 text-blue-400 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path>
...
<div class="relative group">
    ...
    <div class="relative bg-gray-800 bg-opacity-90 rounded-xl overflow-hidden border border-gray-700 group-hover:border-blue-600 transform transition-all duration-500 hover:shadow-lg hover:shadow-blue-900/20 hover:-translate-y-1">
        ...
        <div class="p-6 text-center">
            <div class="mb-6">
                <span class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-400">170%</span>
                <span class="text-gray-300 ml-1">/ Trade</span>
            </div>
            ...
            <ul class="space-y-3 mb-8">
                ...
                <li class="text-white font-semibold flex items-center justify-center border-t border-gray-700 pt-3 mt-3">
                    ...
                    Min: <span class="text-blue-300 ml-1">$1499</span>
                </li>
                <li class="text-white font-semibold flex items-center justify-center">
                    <svg class="w-5 h-5 text-blue-400 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path>
        ...
        <div class="p-6 text-center">
            ...
            <ul class="space-y-3 mb-8">
                ...
                <li class="text-white font-semibold flex items-center justify-center border-t border-gray-700 pt-3 mt-3">
                    ...
                    Min: <span class="text-blue-300 ml-1">$2999</span>
                </li>
                <li class="text-white font-semibold flex items-center justify-center">
                    <svg class="w-5 h-5 text-blue-400 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path>
                    </svg>
                    Max: <span class="text-blue-300 ml-1">$4999</span>
                </li>
            </ul>
...
<div class="relative group">
    ...
    <div class="relative bg-gray-800 bg-opacity-90 rounded-xl overflow-hidden border border-gray-700 group-hover:border-blue-600 transform transition-all duration-500 hover:shadow-lg hover:shadow-blue-900/20 hover:-translate-y-1">
        ...
        <div class="p-6 text-center">
            <div class="mb-6">
                <span class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-400">250%</span>
                <span class="text-gray-300 ml-1">/ Trade</span>
            </div>
            ...
            <ul class="space-y-3 mb-8">
                ...
                <li class="text-white font-semibold flex items-center justify-center border-t border-gray-700 pt-3 mt-3">
                    ...
                    Min: <span class="text-blue-300 ml-1">$999</span>
                </li>
                <li class="text-white font-semibold flex items-center justify-center">
                    <svg class="w-5 h-5 text-blue-400 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path>
                    </svg>
                    Max: <span class="text-blue-300 ml-1">$1499</span>
                </li>
            </ul>
        ...
        <div class="mt-12 p-6 bg-gray-800 bg-opacity-70 rounded-xl border border-gray-700 shadow-lg">
            <div class="flex flex-col md:flex-row items-center justify-between">
                ...
                <div>
                    <a href="contact.php" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 shadow-lg transition duration-300 transform hover:-translate-y-1">
                        Contact Our Team
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div class="space-y-8">
                ...
                <div class="bg-dark-300 rounded-lg p-6 border border-gray-800">
                    ...
                    <div class="mt-6">
                        <a href="login.php" class="inline-flex items-center px-5 py-2 border border-gray-700 text-base font-medium rounded-md text-gray-300 hover:text-white hover:border-primary transition duration-150">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-gray-800 bg-opacity-80 p-6 rounded-xl border border-gray-700 hover:border-blue-500 shadow-lg transition duration-300 transform hover:-translate-y-1 hover:shadow-blue-900/20">
                ...
                <p class="text-gray-300">
                    Featuring the market's sharpest execution, Jarvis Trade Pro cTrader fills your orders in milliseconds without any requotes or price manipulation.
                </p>
            </div>
            ...
            <div class="bg-gray-800 bg-opacity-80 p-6 rounded-xl border border-gray-700 hover:border-blue-500 shadow-lg transition duration-300 transform hover:-translate-y-1 hover:shadow-blue-900/20">
                ...
                <p class="text-gray-300">
                    Easy to use and navigate, Jarvis Trade Pro cTrader was built with real traders' needs in mind. Trade with Jarvis Trade Pro cTrader and experience its distinct advantage.
                </p>
            </div>
        </div>
    </div>
...
<section class="py-16 bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-12 text-center">
            ...
            <h2 class="mt-3 text-3xl font-bold text-white">Why <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600">Jarvis Trade Pro</span> Is One of the World's Most Trusted Brands</h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div class="bg-gray-800 rounded-xl overflow-hidden border border-gray-700 shadow-xl transition duration-300 transform hover:-translate-y-1 hover:shadow-blue-900/20">
                <div class="p-6">
                    ...
                    <div class="mt-8 text-center">
                        <a href="login.php" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 shadow-lg transition duration-300 transform hover:-translate-y-1">
                            Learn More
                            <svg class="ml-2 -mr-1 w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                            </svg>
            ...
            <div class="relative group">
                ...
                <div class="relative bg-gray-800 bg-opacity-90 rounded-xl p-8 shadow-lg border border-gray-700 group-hover:border-blue-600 transform transition-all duration-500 hover:shadow-lg hover:shadow-blue-900/20 hover:-translate-y-2 h-full">
                    ...
                    <div class="mt-auto text-center">
                        <a href="register.php" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 shadow-lg transition duration-300 transform hover:-translate-y-1">
                            Get Started
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div class="bg-gray-800 bg-opacity-80 rounded-xl border border-gray-700 hover:border-blue-600 p-8 shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-blue-900/20">
                ...
                <p class="text-gray-300 mb-6 leading-relaxed">
                    One of the primary goals of Jarvis Trade Pro is to provide the best product in the market. Our relationships with leading tier one financial institutions mean deep liquidity and tighter spreads for Forex traders.
                </p>
...
<section class="py-16 bg-gray-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-12 text-center">
            ...
            <h2 class="mt-3 text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600">Start Trading with Jarvis Trade Pro</h2>
        ...
        <div class="mt-12 text-center">
            <a href="register.php" class="inline-flex items-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 shadow-lg transition duration-300 transform hover:-translate-y-1">
                Start Trading Now
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
            ...
            <div class="relative group"
                ...
                <div class="relative h-full bg-gray-800 bg-opacity-80 rounded-2xl p-6 border border-gray-700 transition-all duration-300 hover:border-blue-500/50">
                    <div class="mb-6">
                        ...
                        <p class="text-gray-300 leading-relaxed text-sm">Since I started using Jarvis Trade Pro, I have been earning like never before. You guys have the best signals.</p>
                    </div>
            ...
            <div class="relative group"
                ...
                <div class="relative h-full bg-gray-800 bg-opacity-80 rounded-2xl p-6 border border-gray-700 transition-all duration-300 hover:border-emerald-500/50">
                    <div class="mb-6">
                        ...
                        <p class="text-gray-300 leading-relaxed text-sm">I already got more than $200,000 within a month investing with Jarvis Trade Pro. Will again invest soon.</p>
                    </div>
                    <div class="flex items-center">
            ...
            <div class="relative group"
                ...
                <div class="relative h-full bg-gray-800 bg-opacity-80 rounded-2xl p-6 border border-gray-700 transition-all duration-300 hover:border-emerald-500/50">
                    <div class="mb-6">
                        ...
                        <p class="text-gray-300 leading-relaxed text-sm">This was a very easy process and I received my funds quickly as I needed them! Highly recommend Jarvis Trade Pro.</p>
                    </div>
                    <div class="flex items-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
                    ...
                    <div class="relative bg-gray-800 bg-opacity-80 rounded-2xl p-6 border border-gray-700 transition-all duration-300 hover:border-blue-500/50">
                        <div class="mb-6">
                            ...
                            <p class="text-gray-300 leading-relaxed text-sm">I rate Jarvis Trade Pro five stars because of the service, you register online, upload ID and you deposit and withdraw after trades. This is so lovely.</p>
                        </div>
                        <div class="flex items-center">
                    ...
                    <div class="relative bg-gray-800 bg-opacity-80 rounded-2xl p-6 border border-gray-700 transition-all duration-300 hover:border-emerald-500/50">
                        <div class="mb-6">
                            ...
                            <p class="text-gray-300 leading-relaxed text-sm">I am very pleased with the customer service. Also online service is great and easy thank you Jarvis Trade Pro team.</p>
                        </div>
                        <div class="flex items-center">
                    ...
                    <div class="relative bg-gray-800 bg-opacity-80 rounded-2xl p-6 border border-gray-700 transition-all duration-300 hover:border-blue-500/50">
                        <div class="mb-6">
                            ...
                            <p class="text-gray-300 leading-relaxed text-sm">I'm happy, that in difficult times there are people that will support you and help you make more money, thank you Jarvis Trade Pro for giving me a chance.</p>
                        </div>
                        <div class="flex items-center">
                    ...
                    <div class="relative bg-gray-800 bg-opacity-80 rounded-2xl p-6 border border-gray-700 transition-all duration-300 hover:border-emerald-500/50">
                        <div class="mb-6">
                            ...
                            <p class="text-gray-300 leading-relaxed text-sm">I've invested with Jarvis Trade Pro several times, always paid back on time. The entire trade process is complete in just a few days. Very impressed and satisfied.</p>
                        </div>
                        <div class="flex items-center">
...
<script type=text/javascript> var host = 'h51.p.ctrader.com';</script><script src=temp/custom/js/spreads-home.html type=module></script>
