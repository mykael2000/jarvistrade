            ...
            <script type="application/ld+json">
                {
                    ...
                    "itemListElement": [
                        ...
                        },
                        {
                            ...
                            "position": 2,
                            "item": {
                                "@id": "https://jarvistradepro.comfor-traders",
                                "name": "For Traders"
                            }
                        }
                    ]
        ...
        <div class="max-w-4xl mx-auto bg-gray-800 bg-opacity-80 backdrop-filter backdrop-blur-sm rounded-xl p-8 border border-gray-700">
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    ...
                    <a href="login.php" class="px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white font-medium rounded-lg transition duration-300 flex items-center justify-center">
                        <span>Login</span>
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
