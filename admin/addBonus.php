...
if (isset($_POST['profit'])) {
    ...
    $type = "bonus";
    $description = "Trading Bonus";
    $prosql = "UPDATE users set total_balance = '$newBal', total_bonus = '$newPro' WHERE id = '$account'";
    $proquery = mysqli_query($conn, $prosql);

    $sqlpde = "INSERT INTO history (client_id, tranx_id, email, type, description, amount, status) VALUES ( '$client_id', '$tranx_id', '$useremail', '$type', '$description', '$amount', '$status')";
