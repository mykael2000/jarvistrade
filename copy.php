            ...
            <div class="w-full md:w-2/3" x-data="{ isVisible: false }" x-init="setTimeout(() => { isVisible = true }, 200)">
                ...
                >
                    ...
                    <div class="flex flex-wrap justify-center gap-4 mt-6">
                        <a href="register.php" class="px-6 py-3 text-base font-medium text-white bg-blue-600 rounded-lg shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition-all duration-200">
                            Get Started
                        </a>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-8" x-data="{ isVisible: false }" x-init="setTimeout(() => { isVisible = true }, 500)">
                ...
                >
                    ...
                    <div class="mt-8">
                        <a href="about.php" title="Learn About Jarvis Trade Pro Trade Commissions" class="inline-flex items-center px-6 py-3 text-base font-medium text-white bg-blue-600 border border-transparent rounded-lg shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-blue-500 transition-all duration-200">
                            Learn More
            ...
            <div class="relative px-8 py-12 md:p-12 lg:px-16 lg:py-16">
                ...
                <div class="relative z-10 text-center max-w-2xl mx-auto">
                    ...
                    <div class="mt-8 flex justify-center">
                        ...
                        <a href="login.php" class="ml-4 px-8 py-4 text-base font-medium text-white bg-transparent border border-white rounded-lg shadow-lg hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-800 transition-all duration-200">
                            Login
                        </a>
                    </div>
                </div>
