                ...
                <script type="application/ld+json">
                    {
                        ...
                        "itemListElement": [
                            ...
                            },
                            {
                                ...
                                "position": 2,
                                "item": {
                                    "@id": "https://jarvistradepro.comtrading",
                                    "name": "Trading"
                                }
                            }
                        ]
                ...
                <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div class="text-center md:text-left">
                        ...
                        <div class="flex items-center justify-center md:justify-start space-x-4">
                            <a href="mailto:admin@jarvistradepro.com" class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-700 hover:bg-gray-600 transition-colors duration-300">
