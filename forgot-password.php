...
<!-- Mirrored from jarvistradepro.com/forgot-password by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Nov 2025 13:25:05 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="csrf-token" content="i9IrwrCK1R06ggCyZDQF50Rx1Qj7KD8SHRjYxISu">
    <title>Jarvis Trade Pro - Forgot your password</title>
...
<body class="h-full bg-gray-300 font-sans antialiased transition-colors duration-300 text-gray-900" x-data="{ darkMode: localStorage.theme === 'dark' || !localStorage.theme }" :class="{ 'dark': darkMode }" x-cloak>
    ...
    <div class="w-full max-w-md space-y-8">
        ...
        <div class="bg-gray-900 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 sm:p-8 space-y-6">
            ...
            <form action="https://jarvistradepro.com/forgot-password" method="post" class="space-y-6">
