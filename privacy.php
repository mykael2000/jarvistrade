                ...
                <div class="mt-12 text-center" x-data="{ open: false }">
                    ...
                    <div x-show="open"
                        ...
                        <p class="text-gray-300">
                            At Jarvis Trade Pro, we take data protection very seriously. All user data is encrypted and stored securely. We never share your personal information with third parties without your explicit consent, and we adhere strictly to international data protection regulations.
                        </p>
                    </div>
                </div>
            </div>
